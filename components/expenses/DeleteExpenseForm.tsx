...
import deleteExpense from "@/actions/delete-expenses-action";
...
export default function DeleteExpenseForm({ closeModal }: DeleteExpenseForm) {
  ...
  const deteleExpenseWithBudgetId = deleteExpense.bind(null, {
    budgetId: Number(budgetId),
    expenseId: Number(expenseId),
  });
  const [state, dispatch] = useActionState(deteleExpenseWithBudgetId, {
    errors: [],
    success: "",
  });
